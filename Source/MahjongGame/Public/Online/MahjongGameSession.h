...
protected:
    ...
    TSharedPtr<class FMahjongOnlineSessionSettings> HostSettings;
    /** Current search settings */
    TSharedPtr<class FMahjongOnlineSearchSettings> SearchSettings;
...
protected:
    ...
    */
    DECLARE_EVENT_TwoParams(AMahjongGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
    ...
    */
    ...
    DECLARE_EVENT_OneParam(AMahjongGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
...
public:
    ...
    virtual uint8 GetMaxPlayers() const;
    ...
    */
    virtual bool HostSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, const FString& GameType, const FString& MapName, bool bIsLAN, bool bIsPresence, int32 MaxNumPlayers);
